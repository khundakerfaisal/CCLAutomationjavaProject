package CPHLCombinedPR;

import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;
import org.openqa.selenium.WebElement;

public class LocalPOApprover {
	private WebDriver driver; // Assuming you initialize this somewhere

	public LocalPOApprover(WebDriver driver) {
		this.driver = driver;
	}

	public void POApprover() throws InterruptedException {
