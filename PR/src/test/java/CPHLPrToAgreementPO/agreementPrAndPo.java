...
//		Thread.sleep(2000);
		 ...
		 * 
		 * WebElement dropdownElementProduct1 =
		 * driver.findElement(By.xpath("//td[@name='product_id']"));
		 * dropdownElementProduct1.click(); Thread.sleep(2000);
		 * 
		 * WebElement itemToSelect = driver.findElement(By.
		 * xpath("//a[contains(text(), '02 pin plug - (91E6100112)')]"));
		 * itemToSelect.click(); Thread.sleep(2000);
		 * 
		 * WebElement prQty =
		 * driver.findElement(By.xpath("//input[@name='product_qty']")); prQty.clear();
		 * prQty.sendKeys("5.000"); Thread.sleep(2000);
		 * 
		 ...
		 * 
		 * WebElement lineSelection2 =
		 * driver.findElement(By.xpath("//a[text()='Add a line']"));
		 * lineSelection2.click(); Thread.sleep(2000); // Start Array Using multiple
		 * item selection with loop
		 * 
		 * String[] dropdownItems = { "04 Way Switch - (91E6100112)" }; int[] quantities
		 * = { 4 }; // Corresponding quantities
		 * 
		 * // Iterate through the dropdown items and quantities for (int i = 0; i <
		 * dropdownItems.length; i++) {
		 * 
		 * WebElement dropdownElementProduct = driver.findElement( By.xpath(
		 * "//*[@id='o_field_input_168']/div[2]/div/table/tbody/tr[2]/td[1]/div/div[1]/div/input"
		 ...
		 * 
		 * // Click the dropdown element dropdownElementProduct.click();
		 * 
		 ...
		 * xpath("//a[text()='04 Way Switch - (91E6100112)']"))); dropdownItem.click();
		 * 
		 * // driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(30));
		 * 
		 * // // Click the dropdown item // dropdownItem.click();
		 * 
		 * // Input the quantity quantityInput.clear();
		 * quantityInput.sendKeys(String.valueOf(quantities[i]));
		 * 
		 * Thread.sleep(2000); try { Thread.sleep(3000); // Wait for 1 second (1000
		 * milliseconds) } catch (InterruptedException e) { e.printStackTrace(); } }
		 * 
		 * // End Array Using multiple product item selection with loop
		 * 
		 * // Pr Save button Pressed WebElement prSubmit =
		 * driver.findElement(By.xpath("//button[@title='Save record']"));
		 * prSubmit.click(); Thread.sleep(3000);
		 * 
		 * // Pr Hod Approval button Pressed WebElement PrHodApproval =
		 * driver.findElement(By.xpath("//button[@name='button_hod_approve']"));
		 * PrHodApproval.click(); Thread.sleep(2000);
		 * 
		 * // Pr pm Approval button Pressed WebElement PrPmApproval =
		 * driver.findElement(By.xpath("//button[@name='button_pm_approve']"));
		 * PrPmApproval.click(); Thread.sleep(2000);
		 * 
		 * // Pr pm-ops Approval button Pressed WebElement PrPmopsApproval =
		 * driver.findElement(By.xpath("//button[@name='button_pm_ops_forward']"));
		 * PrPmopsApproval.click(); Thread.sleep(1000);
		 * 
		 * // Pr forward Approval button Pressed WebElement PrForwardApproval =
		 * driver.findElement(By.xpath("//button[@name='button_forward']"));
		 * PrForwardApproval.click(); Thread.sleep(1000);
		 * 
		 * // Pr Final/Done Approval button Pressed WebElement PrFinalApproval =
		 * driver.findElement(By.xpath("//button[@name='button_done']"));
		 * PrFinalApproval.click(); Thread.sleep(3000);
		 * 
		 * System.out.println("Site Purchase requsition Successfully Completed!");
		 * Thread.sleep(3000);
		 * 
		 * // order menu button Pressed WebElement orderMenuSelection =
		 * driver.findElement(By.xpath("//button[@title='Orders']"));
		 * orderMenuSelection.click(); Thread.sleep(2000);
		 * 
		 * // Site purchase order menu click WebElement sitePoSelection = driver
		 * .findElement(By.xpath(
		 * "//a[@data-menu-xmlid='cphl_local_purchase.menu_action_site_purchase_views']"
		 * )); sitePoSelection.click(); Thread.sleep(2000);
		 * 
		 * // Site purchase order create button click
		 * 
		 * WebElement sitePoCreateButton =
		 * driver.findElement(By.xpath("//button[@data-original-title='Create record']")
		 * ); sitePoCreateButton.click(); Thread.sleep(3000);
		 * 
		 * // Site purchase order vendor selection
		 * 
		 * WebElement inputElement = driver .findElement(By.
		 * xpath("//div[contains(@placeholder, 'Name, TIN, Email, or Reference')]"));
		 * inputElement.click(); Thread.sleep(2000);
		 * 
		 ...
		 * sitePoVendorSelection.click(); Thread.sleep(2000);
		 * 
		 * // Site po--PR dropdown value selection work start
		 * 
		 * WebElement prDropdownclick =
		 * driver.findElement(By.xpath("//div[@name='purchase_request_id']"));
		 * prDropdownclick.click(); Thread.sleep(2000);
		 * 
		 * WebElement firstItem =
		 * driver.findElement(By.xpath(".//li[@class='ui-menu-item'][1]/a")); // Click
		 * on the first item firstItem.click();
		 * System.out.println("Dropdown PR selection perfectly"); Thread.sleep(3000);
		 * 
		 * WebElement sitePObudgetclick =
		 * driver.findElement(By.xpath("//div[@name='budget_id']"));
		 * sitePObudgetclick.click();
		 * 
		 * // WebDriverWait wait3 = new WebDriverWait(driver, Duration.ofSeconds(20));
		 * // Adjust the timeout as needed // WebElement sitePObudgetselect = wait3 //
		 * .until(ExpectedConditions.presenceOfElementLocated(By.xpath(
		 * "//ul[@id='ui-id-2']/li[6]/a"))); // sitePObudgetselect.click();
		 * 
		 * WebDriverWait wait3 = new WebDriverWait(driver, Duration.ofSeconds(20));
		 * WebElement element =
		 ...
		 * ))); element.click(); Thread.sleep(3000);
		 * 
		 * // WebDriverWait wait3 = new WebDriverWait(driver, Duration.ofSeconds(20));
		 * // try { // WebElement element = wait3 //
		 * .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
		 * "//ul[@id='ui-id-46']/li[6]/a"))); // element.click(); // } catch
		 * (TimeoutException e) { //
		 ...
		 * WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20)); //
		 * Create a WebDriverWait instance with // a timeout (in seconds) first cell //
		 * selection
		 * 
		 * WebElement firstCellRfq = wait
		 * .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
		 * "tr.o_data_row:first-child"))); // Wait // for // the // First // table //
		 * cell // selection
		 * 
		 * firstCellRfq.click(); WebElement unitPrice1Selection =
		 * firstCellRfq.findElement(By.xpath("//td[@name='price_unit']/input")); //
		 * First // row // price // input // button // click
		 * unitPrice1Selection.clear(); unitPrice1Selection.sendKeys("600"); //
		 * input/Set First row unit price unitPrice1Selection.sendKeys(Keys.ENTER); //
		 * Enter Second selected cell Thread.sleep(2000);
		 * 
		 * System.out.println("Price assign suceesfully in first table data!");
		 * 
		 * WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(30)); //
		 * Create a WebDriverWait instance with // a timeout (in seconds) Second // cell
		 * selection WebElement secondCellRfq =
		 * wait2.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
		 * "//td[@class='o_data_cell o_field_cell o_list_number o_required_modifier']/input[@name='price_unit']"
		 * ))); // Second // row // price // input // button // click
		 * secondCellRfq.click(); secondCellRfq.clear(); secondCellRfq.sendKeys("700");
		 * // input/Set Second row unit price
		 * 
		 * System.out.println("Price assign suceesfully in second table data!"); //
		 * Table td data unit price input work Close..
		 * 
		 * // RfQ submit button work start .. WebElement sitPOSubmit =
		 * driver.findElement(By.xpath("//button[@title='Save record']")); // RFQ final
		 * submission sitPOSubmit.click(); Thread.sleep(2000); // RfQ submit button work
		 * close .. System.out.println("Site PO Created successfully!");
		 */
